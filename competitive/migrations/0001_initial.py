...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('result', models.CharField(choices=[('Correct', 'Correct'), ('Time Limit Exceeded', 'Time Limit Exceeded'), ('Wrong Answer', 'Wrong Answer'), ('Compiler Error', 'Compiler Error'), ('Memory Limit Exceeded', 'Memory Limit Exceeded'), ('Run Time Error', 'Run Time Error'), ('No Output', 'No Output'), ('Judging', 'Judging')], max_length=200)),
                ...
                ('language', models.ForeignKey(limit_choices_to={'enable': True}, on_delete=django.db.models.deletion.CASCADE, to='competitive.Language')),
                ('problem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='problem.Problem')),
                ('server', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='judgeserver.JudgeServer')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('execution_time', models.DecimalField(decimal_places=8, default=0.0, max_digits=22, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
                ('memory_usage', models.DecimalField(decimal_places=8, default=0.0, max_digits=22, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
