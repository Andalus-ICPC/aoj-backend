    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authentication.Campus')),
                ('problem', models.ManyToManyField(blank=True, to='problem.Problem')),
                ('user', models.ManyToManyField(blank=True, limit_choices_to={'is_active': True, 'role__short_name': 'contestant'}, to=settings.AUTH_USER_MODEL)),
            ],
        ),
